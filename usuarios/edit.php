        ...
        <div class='content' data-role='content'>
            ...
            <ul data-inset='true' data-role='listview' data-theme='d'>
                <li>
	                ...
	                <form name="dos" action="update.php" method="post">
	                    <input type="hidden" name="id" value="<?echo $usuarios['id'];?>">  
                      <div id="contenedor">
                    		<div id="contenidos">
                      			<div id="columna1">
                        			Nombre de usuario
                      			...
                      			<div id="columna2">
                      				<input type="text" name="user" value="<?echo $usuarios['username'];?>" required>	
	                      		</div>              
                    		</div>
                    		<div id="contenidos">
                      			<div id="columna1">
                      			...
                      			<div id="columna2">
                      				<input type="password" name="pass" value="<?echo $usuarios['pass'];?>" required>	
	                      		</div>              
                    		</div>   
                    		<div id="contenidos">
                      			<div id="columna1">
                                ...
                                <?php 
                                    ...
                                    if ($nivel == 3){
                                      $nivelFinal = "Administrador de contrato cliente";     
                                      }
                                    if ($nivel == 4){
                                      $nivelFinal = "Encargado de mantenciones cliente";     
                                      }
                                    echo strtoupper($nivelFinal);                                  
	                      		      ?>
                            </div>              
                    		</div> 
                    		<div id="contenidos">
                    		...
                    		<div id="contenidos">
                      			...
                      			<div id="columna2">
                      				<input type="text" name="name" value="<?echo $usuarios['nombres'];?>" required>	
	                      		</div>              
                    		</div>
                    		<div id="contenidos">
                      			<div id="columna1">
                      			...
                      			<div id="columna2">
                      				<input type="text" name="last_name" value="<?echo $usuarios['apellidos'];?>" required>	
	                      		</div>              
                    		</div>
                    		<div id="contenidos">
                      			<div id="columna1">
                      			...
                      			<div id="columna2">
                      				<input type="text" name="mail" value="<?echo $usuarios['correoContacto'];?>" required>	
	                      		</div>              
                    		</div>
                    		<div id="contenidos">
                      			<div id="columna1">
                      			...
                      			<div id="columna2">
                      				<input type="number" name="phone" value="<?echo $usuarios['fonoContacto'];?>">	
	                      		</div>              
                    		</div>
    		            </div>
	                    <center>
