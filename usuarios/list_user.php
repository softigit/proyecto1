...
if (($_SESSION['nivel']==0) &&  ($_SESSION['id']!="")){
  	...
  	$sql = "SELECT * FROM usuarios  WHERE estado = 0 and (nivel = 0 OR nivel = 1 OR nivel = 2 OR nivel = 5) ORDER BY nombres ASC";
		                ...
		                <?php
		                	...
		                	<div id="contenidos">
		    	          		...
		    	          		<div id="columna3" style="background-color:#<?php echo $color;?>">                  			
				        			<form name="1" action="view2.php" method="post">
		    	          		...
		    	          		<div id="columna3" style="background-color:#<?php echo $color;?>">                  			
									<form name="2" action="edit2.php" method="post">
										<input type="hidden" name="idCliente" id="idCliente" value="<?php echo $rowCliente["id"];?>">
								        <center>
 											<button aria-label='button1' data-theme='chase' name='button1' role='button' type='submit' value='submit' >
		    	          		...
		    	          		<div id="columna3" style="background-color:#<?php echo $color;?>">                  																			
									<form name="3" action="block_out2.php" method="post">
										<input type="hidden" name="idCliente" id="idCliente" value="<?php echo $rowCliente["id"];?>">
								        <center>
 											<button aria-label='button1' data-theme='chase' name='button1' role='button' type='submit' value='submit' >
