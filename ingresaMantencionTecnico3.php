...
<div id="contenidos">
  ...
  <?php if ($row_Mantencion1['foto1'] == null){ ?>
    <div id="contenidos">
      <div id="columna1">Foto 1:</div>
      <div id="columna2"> 
          <form action="subeFoto1.php?idM=<?php echo $idM; ?>&idS=<?php echo $idS; ?>" method="post" enctype="multipart/form-data" data-ajax="false">
            <input type="hidden" name="MM_insert" value="form1" />
            <input type="file" name="foto1" id="foto1" />
            <center>
              <input aria-label='button1' data-theme='chase' name='button1' role='button' type='submit' value='Subir Foto 1'/>
            </center>
          </form>  
  ...
  <?php } ?>
  <?php if ($row_Mantencion1['foto2'] == null){ ?>
      <div id="contenidos">
        <div id="columna1">Foto 2:</div>
        <div id="columna2"> 
          <form action="subeFoto2.php?idM=<?php echo $idM; ?>&idS=<?php echo $idS; ?>" method="post" enctype="multipart/form-data" data-ajax="false">
            <input type="hidden" name="MM_insert" value="form1" />
            <input type="file" name="foto2" id="foto2" />
            <center>
              <input aria-label='button1' data-theme='chase' name='button1' role='button' type='submit' value='Subir Foto 2'/>
            </center>
          </form>  
        </div>
      </div> 
  ...
  <?php $nivel; if (($nivel == 1) || ($nivel == 5)){?>
    <form name="1" action="mantencionPorFechaTecnico.php" method="post">
      <input type="hidden" name="idSucursal" id="idSucursal" value=<?php echo $idS; ?>  />
