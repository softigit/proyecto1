<?php 
  ...
  if ($_SESSION['idEmpresa']!="" ){
    ...
    $queryAgTotal = "select * from agenda where idEmpresa = $cia and requiere != 0 ORDER BY fecha ASC";
    $agTotal = mysql_query($queryAgTotal, $conexion1) or die(mysql_error());
    $agTotalNumero = mysql_num_rows($agTotal);

    $queryAgEst1 = "select * from agenda where idEmpresa = $cia and requiere = 1 ORDER BY fecha ASC";
    $agEst1 = mysql_query($queryAgEst1, $conexion1) or die(mysql_error());
    $agEst1Numero = mysql_num_rows($agEst1);

    $queryAgEst2 = "select * from agenda where idEmpresa = $cia and requiere = 2 ORDER BY fecha ASC";
    $agEst2 = mysql_query($queryAgEst2, $conexion1) or die(mysql_error());
    $agEst2Numero = mysql_num_rows($agEst2);

    $queryAgEst3 = "select * from agenda where idEmpresa = $cia and requiere = 3 ORDER BY fecha ASC";
    $agEst3 = mysql_query($queryAgEst3, $conexion1) or die(mysql_error());
    $agEst3Numero = mysql_num_rows($agEst3);

    $queryAgEst4 = "select * from agenda where idEmpresa = $cia and requiere = 4 ORDER BY fecha ASC";
    $agEst4 = mysql_query($queryAgEst4, $conexion1) or die(mysql_error());
    $agEst4Numero = mysql_num_rows($agEst4);

    $queryAgEst5 = "select * from agenda where idEmpresa = $cia and requiere = 5 ORDER BY fecha ASC";
    $agEst5 = mysql_query($queryAgEst5, $conexion1) or die(mysql_error());
    $agEst5Numero = mysql_num_rows($agEst5);

    $queryAgEst6 = "select * from agenda where idEmpresa = $cia and requiere = 6 ORDER BY fecha ASC";
    $agEst6 = mysql_query($queryAgEst6, $conexion1) or die(mysql_error());
    $agEst6Numero = mysql_num_rows($agEst6);

    $queryAgEst7 = "select * from agenda where idEmpresa = $cia and requiere = 7 ORDER BY fecha ASC";
  ...
  <body>
    ...
    <div class='header' data-backbtn='false' data-role='header' data-theme='chase'>
      ...
      <div class='content' data-role='content'>
        <h2>Estado Ordenes para <?php echo $empresas["nombreEmpresa"]?></h2>
              ...
              <div id="contenedorOrdenesAdmin">           
                ...
                <script type="text/javascript" language="javascript">
                  function cargapagina(requiere){
                    window.location ="listadoOrdenesAdmin.php?req="+requiere;
                    }
                </script>  
                ...
                <div id="contenidosOrdenesAdmin" onclick="cargapagina(2);">
                  <div id="columna1OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                    3  
                  </div>                  
                  <div id="columna2OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                  ...
                  <div id="columna3OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                     <?php echo $agEst2Numero;?> 
                  </div>              
                </div>
                <div id="contenidosOrdenesAdmin" onclick="cargapagina(3);">
                  <div id="columna1OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                    4  
                  </div>                  
                  <div id="columna2OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                ...
                <div id="contenidosOrdenesAdmin" onclick="cargapagina(4);">
                  <div id="columna1OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                    5  
                  </div>                  
                  <div id="columna2OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                  ...
                  <div id="columna3OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                     <?php echo $agEst4Numero;?> 
                  </div> 
                </div>  
                <div id="contenidosOrdenesAdmin" onclick="cargapagina(5);">
                  <div id="columna1OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
                    6  
                  </div>                  
                  <div id="columna2OrdenesAdmin" style="background-color:#<?php echo $color;?>">                        
