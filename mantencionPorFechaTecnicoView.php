<?php session_start(); 
  if ($_SESSION['idEmpresa']!="" ){
    ...
    $idEquipo = $row_Mantencion1["idEquipo"];
    $sql2="Select * from equipo where idEquipo = $idEquipo";
    $equipo_array = mysql_query($sql2, $conexion1) or die(mysql_error());
  ...
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <div data-role='page' data-theme='chase' id='contacto'>
        ...
        <h2>Mantención N° <?php echo $_GET["idM"]; ?>  </h2>
          ...
          <ul data-inset='true' data-role='listview' data-theme='d'>
            <li>     
              <div id="contenedor">
                <div id="contenidos">
                  <div id="columna1">Equipo</div>
                  <div id="columna2">
                    <?php 
                        echo $equipos["nroEquipo"];
                      ?>
                  </div>       
                </div>
                <div id="contenidos">
          ...
          <ul data-inset='true' data-role='listview' data-theme='d'>
            <li>
              <a href="http://www.myu.cl/intranet2/actuMantencionTecnico2.php?idM=<?php echo $_GET['idM'];?>&idE=<?php echo $_GET['idE'];?>&sucursal=<?php echo $_GET['sucursal'];?>&mes=<?php echo $_GET['mes'];?>&anio=<?php echo $_GET['anio'];?>">
