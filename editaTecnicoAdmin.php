        ...
        <div data-role='page' data-theme='chase' id='contacto'>
          ...
          <div class='content' data-role='content'>
            <ul data-inset='true' data-role='listview' data-theme='d'>
              <li>
                <form action="gestionOrdenesAdmin.php?idAg=<?php echo $idAgenda;?>" method="post">
                  <center>
            ...
            <form action="editaTecnicoAdminFin.php" method="post" name="form1" id="form1">
                  ...
                  <li>
                    ...
                    <select name="tecnico" >
                      <?php 
                        ...
                        $query_tecnico = "select u.estado,u.id,u.nombres,u.apellidos,u.nivel from usuarios as u where u.estado = 0 and (u.nivel = 1 or u.nivel = 5) ORDER BY u.nombres ASC";
