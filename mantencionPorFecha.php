  ...
  <body>
    <div data-role='page' data-theme='chase' id='contacto'>
        ...
        <div class='content' data-role='content'>
          <h2>B&uacute;squeda por Fecha</h2>
            ...
            <li>
              <form action="ordenMantencion.php" method="post" name="form3" id="form3">
                 <button aria-label='button1' data-theme='chase' name='button1' role='button' type="submit">
                    <span aria-hidden='true'>BUSCAR MANTENCI&Oacute;N</span>
                  </button>
              </form>  
            </li>
            <li>
              ...
              ?> 
              <li>
                <form action="mantencionPorFecha.php" method="post" name="form3" id="form3">
                  <button aria-label='button1' data-theme='chase' name='button1' role='button' type="submit">
              ...
              $idSucursal = 8;
              $cia = 8;
              $bequipo = "SELECT * FROM edificio as ed,equipo as eq WHERE eq.idEdificio = ed.idEdificio and ed.idSucursal = $idSucursal ORDER BY eq.idEdificio,nroEquipo ASC";// original
              //$bequipo = "SELECT * FROM edificio as ed,equipo as eq WHERE eq.idEdificio = ed.idEdificio and ed.idSucursal = $idSucursal ORDER BY eq.idEdificio,nroEquipo ASC"; original
              ...
              while ($rowEquipo2 = mysql_fetch_array($buscaEquipoEdiSucrsual2)){
                  ...
                  //echo "SELECT * FROM mantencion WHERE idEquipo = $idEq and (fecha BETWEEN '$bManIni' AND '$bManFni')"."<br/>";
                  ...
                  //echo "SELECT * FROM mantencion WHERE idEquipo = $idEq and (fecha BETWEEN '$bManIni' AND '$bManFni') and observacion != ' '<br/>";
              ...
              while ($rowEquipo = mysql_fetch_array($buscaEquipoEdiSucrsual)){
                  ...
                  while ($rowMan = mysql_fetch_array($bMantencion)){
                    ...
                    if ($mantencion == 0){
                      //<div id="columna1" style="background-color:#EDE4DA;">
                     if (($_SESSION['nivel'] <= 1)){ 
                        echo "<div id='equipoAmarillo'>".$rowEquipo["nroEquipo"]."</div>";
                        echo "&nbsp;&nbsp;&nbsp;";
                        }  
                     if (($_SESSION['nivel'] == 4) || ($_SESSION['nivel'] == 3)){ 
                        echo "<div id='equipoAmarillo'>".$rowEquipo["nroEquipo"]."</div>";
                        echo "&nbsp;&nbsp;&nbsp;";
                        }  
                      }
                        ...
                        if ($obserMuestra != ''){
                          if ($fotoPend == 0){
                            echo "<div id='equipoRojo'><a href='http://www.softiago.cl/Api/Mantencion/sistema/mantencionPorFecha2.php?idM=".$mantencion."&idE=".$rowEquipo['idEquipo']."&sucursal=".$rowEquipo['idSucursal']."&mes=".$mes."&anio=".$anio."'>".$rowEquipo["nroEquipo"]."</a></div>";
                            echo "&nbsp;&nbsp;&nbsp;"; 
                            }
                          if ($fotoPend == 1){
                             if (($_SESSION['nivel'] == 4) || ($_SESSION['nivel'] == 3)){                             
                             ...
                             if (($_SESSION['nivel'] <= 1)){                             
                                echo "<div id='equipoAnaranjado'><a href='http://www.softiago.cl/Api/Mantencion/sistema/mantencionPorFecha2.php?idM=".$mantencion."&idE=".$rowEquipo['idEquipo']."&sucursal=".$rowEquipo['idSucursal']."&mes=".$mes."&anio=".$anio."'>".$rowEquipo["nroEquipo"]."</a></div>";
                                echo "&nbsp;&nbsp;&nbsp;"; 
                              }                                 
                            }
                          }
                          ...
                          if ($fotoPend == 0){
                            echo "<div id='equipoVerde'><a href='http://www.softiago.cl/Api/Mantencion/sistema/mantencionPorFecha2.php?idM=".$mantencion."&idE=".$rowEquipo['idEquipo']."&sucursal=".$rowEquipo['idSucursal']."&mes=".$mes."&anio=".$anio."'>".$rowEquipo["nroEquipo"]."</a></div>";
                            echo "&nbsp;&nbsp;&nbsp;"; 
                            }
                          if ($fotoPend == 1){
                             if (($_SESSION['nivel'] == 4) || ($_SESSION['nivel'] == 3)){                             
