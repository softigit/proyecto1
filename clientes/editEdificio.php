    ...
    <body>
      <div data-role='page' data-theme='chase' id='contacto'>
        ...
        <div class='content' data-role='content'>
            <h2><?=$nombreEmpresa;?> - <?= $nombreSucursal?>: Edita Edificio</h2>
            <ul data-inset='true' data-role='listview' data-theme='d'>
                <li>
	                ...
	                <form name="dos" action="updateEdificio.php" method="post">
                    		<div id="contenidos">
                      			<div id="columna1">
                        			Nombre Edificio
                      			</div>
                      			<div id="columna2">
                      				<input type="text" name="name" placeholder="Nombre Sucursal" value="<?= strtoupper($nombreEdificio);?>" required>	
	                      		</div>              
                    		</div>
                        <div id="contenidos">
                            <div id="columna1">
                            ...
                            <div id="columna2">
                              <input type="hidden" name="idEdificio" placeholder="idEdificio" value="<?= $idEdificio;?>" required>  
                              ...
                              <input type="text" name="dire" placeholder="Direccion" value="<?= strtoupper($direccion);?>" required> 
                            </div>              
                        </div>
	                    <center>
		                    <button aria-label='button1' data-theme='chase' name='button1' role='button' type='submit' value='submit' >
