<?php 
   ...
   if (($_SESSION['nivel']==0) &&  ($_SESSION['id']!="")){
      ...
      $tecnico = $_POST["tecnico"]; 
		  ...
		  $sql="UPDATE sucursal SET nombreSucursal = '$name', Encargado = '$encargado', Email = '$mail', Tecnico = $tecnico WHERE idSucursal = $idSucursal";
      ...
      /*FIn correos enviar*/
        ...
        */
        ...
        $mail->Subject = $ciaMail." - SUCURSAL EDITADA"; 
        $body='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
          <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
              ...
              <table width="100%" border="0">
                <tr>
                    <td colspan="5"><strong>Informamos se ha editado la sucursal '.$name.' asociada al cliente '.$ciaMail.'</strong></td>
                </tr>
              </table>  
              <br/><br/>    
              <table width="100%" border="0">
