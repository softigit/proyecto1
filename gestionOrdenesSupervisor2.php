        ...
        <div data-role='page' data-theme='chase' id='contacto'>
          ...
          <div class='content' data-role='content'>
            ...
            <ul data-inset='true' data-role='listview' data-theme='d'>
              <li>
                <form action="listadoOrdenesSupervisor.php?req=<?php echo $agendas['requiere']?>" method="post">
                  <center>
               ...
               <ul data-inset='true' data-role='listview' data-theme='d'>
                  ...
                  <li>
                    ...
                    <?php 
                      ...
                      ?>
                      <form action="editaTecnicoSup2.php" method="post">
                  ...
                  <li>
                    ...
                    if ($agendas['nroEquipo'] == 99999){
                       ...
                       ?>
                      <form action="editaNumeroSup2.php" method="post">
                ...
                <form action="generarVisita5Fin.php" method="post" name="form1" id="form1">
                <ul data-inset='true' data-role='listview' data-theme='d'>
                  <li>
                    Observaciones<br/><br/>
                    <?= $observa; ?>
