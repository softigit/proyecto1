      ...
      <body>
        <div data-role='page' data-theme='chase' id='contacto'>
          ...
          <ul data-inset='true' data-role='listview' data-theme='d'>
            <li>
              <a href="http://www.myu.cl/intranet/ingresaMantencionTecnico3.php?idE=<?php echo $_GET['idE'];?>&sucursal=<?php echo $_GET['sucursal'];?>&mes=<?php echo $_GET['mes'];?>&anio=<?php echo $_GET['anio'];?>">
                Volver  
              </a>
            </li> 
            <li >
