...
<body>
 <div data-role='page' data-theme='chase' id='contacto'>
  ...
  <h2>
            Agregar Mantenci&oacute;n            
          </h2>
           <ul data-inset='true' data-role='listview' data-theme='d'>
           <li >
<input type="hidden" name="idEquipo" id="idEquipo" value="<?php echo $idEquipo; ?>" ><input type="hidden" name="tipoTrabajo" id="tipoTrabajo" value="1" >
<p align="center">Fecha = <?php echo date("d-m-Y"); ?></p>
</li>
<li>
Pila <input type="checkbox" />
