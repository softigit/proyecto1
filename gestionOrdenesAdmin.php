        ...
        <div data-role='page' data-theme='chase' id='contacto'>
          ...
          <div class='content' data-role='content'>
            ...
            <ul data-inset='true' data-role='listview' data-theme='d'>
              <li>
                <form action="listadoOrdenesAdmin.php?req=0" method="post">
                  <center>
              ...
              <li>
                  ...
                  <li>
                    ...
                    <?php 
                      ...
                      ?>
                      <form action="editaTecnicoAdmin.php" method="post">
                  ...
                  <li>
                    ...
                    if ($agendas['nroEquipo'] == 99999){
                       ...
                       ?>
                      <form action="editaNumeroAdmin.php" method="post">
            ...
            <form action="eliminaOrden.php" method="post" name="form2" id="form2">
                <ul data-inset='true' data-role='listview' data-theme='d'>
                  <li>
                    <input type="hidden" name="idAgenda" value="<?php echo $agendas["idAgenda"];?>"/>
