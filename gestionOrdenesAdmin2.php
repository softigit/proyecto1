        ...
        <div data-role='page' data-theme='chase' id='contacto'>
          ...
          <div class='content' data-role='content'>
            ...
            <ul data-inset='true' data-role='listview' data-theme='d'>
              <li>
                <form action="listadoOrdenesAdmin.php?req=<?php echo $agendas['requiere'];?>" method="post">
                  <center>
               ...
               <ul data-inset='true' data-role='listview' data-theme='d'>
                  <script language="javascript" type="text/javascript">
                    ...
                    function confirmar2(){
                    var txt;
                    var r = confirm("Desea eliminar esta orden");
                    if (r == true) {
                      form2.submit();
                      txt = "You pressed OK!";} 
                    else {
                  ...
                  <li>
                    ...
                    <?php 
                      ...
                      $query_tecnico = "SELECT * FROM usuarios where  id=$idTecnico";
                      $tecnico = mysql_query($query_tecnico, $conexion1) or die(mysql_error());
                      $row_usuariosTec = mysql_fetch_assoc($tecnico);      
                      echo $row_usuariosTec['nombres']." ".$row_usuariosTec['apellidos'];
                      ?>
                      <form action="editaTecnicoAdmin2.php" method="post">
                        <input type="hidden" name="idTecnico" value="<?php echo $agendas['idTecnico']?>">
                        <input type="hidden" name="idorden" value="<?php echo $agendas['idAgenda']?>">
                        <center>
                          <button aria-label='button1' data-theme='chase' name='button1' role='button' type='submit' value='submit' >
                            <span aria-hidden='true'>Editar Tecnico</span>
                          </button>
                        </center>
                      </form>
                  </li>                  
                  <li>
                    ...
                    if ($agendas['nroEquipo'] == 99999){
                       ...
                       ?>
                      <form action="editaNumeroAdmin2.php" method="post">
                ...
                <form action="generarVisita3Fin.php" method="post" name="form1" id="form1">
                <ul data-inset='true' data-role='listview' data-theme='d'>
                  <li>
                    Observaciones<br/><br/>
                    <?= $observa; ?>
                  ...
                  <li> Comentarios: <?php echo $agendas['comentario'];?><li>
                    Estado
            ...
            <form action="eliminaOrden2.php" method="post" name="form2" id="form2">
                <ul data-inset='true' data-role='listview' data-theme='d'>
                  <li>
                    <input type="hidden" name="idAgenda" value="<?php echo $agendas["idAgenda"];?>"/>
                    <input name="button" type="button" data-theme='chase' id="button" onclick="confirmar2();" value="Eliminar Orden" />
                  </li>  
                </ul>
            </form>
          </div>     
