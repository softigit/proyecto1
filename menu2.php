      ...
      <body>
          ...
          <div class='content' data-role='content'>
            <h2>Intranet</h2>
                ...
                <ul data-inset='true' data-role='listview' data-theme='d'>
                  <li>
                    <a href='menuVisita.php'>
                      <div class='menu-icon more-alerts-icon ui-li-thumb menu-item-icon'></div>
                      <div class='menu-text-with-icon'>
                       Revisar Orden de Visita
                      </div>
                    </a>
                  </li>
                </ul>
                ...
                <ul data-inset='true' data-role='listview' data-theme='d'>
                  <li>
                    <a href='seleccionarEmpresa2.php'>
