...
agenda 
where
Estado <>'Listo' and idusuario='$idUsuario'
and tipoSolicitud=1 
order by idEmpresa,fecha,idSucursal";
 */
 $sql="SELECT * FROM agenda where idEmpresa=$cia and fecha >= '2017-01-01'
and tipoSolicitud=1 order by fecha,idSucursal";
...
<div id="contenedor">
    <div id="contenidos">
        <div id="columna1" style="background-color:#EDE4DA;">Nro Orden</div>
        <div id="columna1" style="background-color:#EDE4DA;">Fecha Visita</div>
    ...
    <div id="contenidos" onclick="cargapagina(<?php echo $row_Mantencion["idAgenda"];?>);">
      <div id="columna1" style="background-color:#<?php echo $color;?>" ><?php  echo $row_Mantencion['idAgenda'];?></div>
      <div id="columna1" style="background-color:#<?php echo $color;?>  " >
        ...
        <div id="columna3" style="background-color:#<?php echo $color;?>"><?php echo chop($row_Mantencion["estado"]); ?></div>  
    </div>
