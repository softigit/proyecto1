        ...
        <div data-role='page' data-theme='chase' id='contacto'>
          ...
          <div class='content' data-role='content'>
            <ul data-inset='true' data-role='listview' data-theme='d'>
              <li>
                <form action="gestionOrdenesTecnico2.php?idAg=<?php echo $idAgenda;?>" method="post">
                  <center>
            ...
            <form action="editaNumeroTecnico2Fin.php" method="post" name="form1" id="form1">
               ...
               <ul data-inset='true' data-role='listview' data-theme='d'>
                  ...
                  <li>
                    ...
                    <select name="idSucursal" >
                      <?php 
                        mysql_select_db($database_conexion1, $conexion1);
                        $query_Agenda = "SELECT * FROM agenda where idAgenda = idAgenda";
                        $agendas = mysql_query($query_Agenda, $conexion1) or die(mysql_error());
             						while ($rowAgenda = mysql_fetch_array($agendas)){
            							$cia=$rowAgenda['idEmpresa'];
            							}
