...
a.idUsuario=$idUsuario order by b.nombreEmpresa ASC";
}
...
<link href="themes/chase/chase.css" rel="stylesheet" />
   ...
   function salir()
   {
	   var pagina="<?php echo "http://$host$uri/$extra";?>";
...
<body>
 <div data-role='page' data-theme='chase' id='contacto'>
        <div class='header' data-backbtn='false' data-role='header' data-theme='chase'>
          ...
          <a class='top-left-link home' data-icon='home' href='menu.php' onclick="salir();">Inicio</a>
        </div>
        ...
        <div class='content' data-role='content'>
          <h2>Seleccione la empresa</h2>
			...
			do {
				?>
            <form action="menu.php" method="post" name="form<?php echo $i;?>" id="form<?php echo $i;?>">
